...
export default async function HomePage() {
  ...
  // sections in order via the SHARED renderer (renderDocumentSections), which
  // skips disabled ones and any type not in the registry. The preview route
  // renders through the SAME function so the live page and the builder preview
  // can't drift. Unknown types render nothing — never crash.
  if (doc) {
    return (
      <StorefrontShell>
        <PartyClassicHeader />
