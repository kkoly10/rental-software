...
export async function IntegrationsBar() {
  const m = await getMessages();
  const integrations = [
    {
      name: "Stripe",
      description: m.integrationsBar.labels.payments,
    ...
    {
      name: "Supabase",
      description: m.integrationsBar.labels.database,
    ...
    {
      name: "Resend",
      description: m.integrationsBar.labels.emails,
    ...
    {
      name: "Next.js",
      description: m.integrationsBar.labels.platform,
    ...
    {
      name: "Vercel",
      description: m.integrationsBar.labels.hosting,
    ...
    <section className="section integrations-section">
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <div className="kicker">{m.integrationsBar.kicker}</div>
          <h2 style={{ margin: "8px 0 0" }}>
            {m.integrationsBar.title}
          </h2>
        </div>
