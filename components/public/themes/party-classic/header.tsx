      ...
      <header className="st-header">
        <div className="st-container st-nav">
            ...
            {brand.logoUrl ? (
              ...
              <>
                ...
                <span className="st-logo-text">
                  <span className="st-logo-name">{settings.businessName}</span>
          ...
          <nav className="st-nav-links">
            ...
            {showPhone && (
              <span className="st-nav-phone" style={{ background: "transparent", padding: "8px 6px" }}>
                {phoneDisplay}
              </span>
            )}
            <Link href="/inventory" className="st-nav-cta">
