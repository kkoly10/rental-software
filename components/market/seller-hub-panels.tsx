 ...
 * surface, rendered by BOTH chromes (Amazon model: one Seller
 * Central, two doors):
 *   - /dashboard/marketplace  (operator dashboard tab)
 *   - /market/hub             (marketplace-branded hub)
 * Operator-class markup (panel/order-card/...) is restyled inside
 * .mk-root by the compatibility block in market.css.
 */
type ProfileRow = {
  slug: string;
  display_name: string;
 ...
 */
export async function SellerHubPanels() {
