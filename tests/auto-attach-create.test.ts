    ...
    orders: [
      {
        ...
        delivery_address_id: "addr-mock", customer_addresses: { line1: "123 Main St" },
    ...
    orders: [
      {
        ...
        organization_id: orgId,
        event_date: "2026-07-04",
        delivery_address_id: "addr-mock", customer_addresses: { line1: "456 Oak St" },
    ...
    orders: [
      {
        ...
        organization_id: orgId,
        event_date: "2026-07-04",
        delivery_address_id: "addr-mock", customer_addresses: { line1: "789 Pine Ave" },
        event_start_time: null,
        deleted_at: null,
      },
    ],
    ...
    orders: [
      {
        ...
        organization_id: orgId,
        event_date: null,
        delivery_address_id: "addr-mock", customer_addresses: { line1: "100 Anywhere" },
        deleted_at: null,
      },
    ],
    route_stops: [],
    ...
    orders: [
      {
        ...
        organization_id: orgId,
        event_date: "2026-07-04",
        delivery_address_id: "addr-mock", customer_addresses: { line1: "" },
        deleted_at: null,
      },
    ],
    route_stops: [],
    ...
    orders: [
      {
        ...
        organization_id: orgId,
        event_date: "2026-07-04",
        delivery_address_id: "addr-mock", customer_addresses: { line1: "111 First" },
        event_start_time: null,
        deleted_at: null,
      },
    ],
