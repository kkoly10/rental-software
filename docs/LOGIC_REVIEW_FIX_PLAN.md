...
### [ ] 1.3 — Show "you are in: {org.name}" in the dashboard shell — `[breaking-ux]`
...
### [ ] 1.6 — Confirmation step + side-effect preview on crew stop actions — `[breaking-ux]`
- **Effort:** S | **Impact:** 4 | **Owner:** ?
...
### [ ] 1.8 — Block sign-before-sent at the portal
...
### [ ] 2.13 — Deposit minimum clamp visible to the customer
- **Effort:** XS | **Impact:** 3 | **Owner:** ?
...
### [ ] 3.1 — Org switcher UI + active-org persistence — `[migration]` `[breaking-ux]`
- **Effort:** L | **Impact:** 5 | **Owner:** ?
...
### [ ] 4.11 — Auto-created asset tag collision risk on duplicate product names
- **Effort:** XS | **Impact:** 1 | **Owner:** ?
